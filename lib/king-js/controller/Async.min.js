...
c=n;var d=!0;c&&(d=c(b,a));d&&l&&l(b,a);f&&f(b,a)}else return b=null,g.length>h?(b=g[h],n=b.OnError,b.Func(this,c.Content),++h):(e="ok",k&&k(a),f&&f(b,a)),this},Do:function(a){if("none"!=e)return this.log("Notify","Async status must be none"),this;e="runing";a||(a={});k=a.Ok;f=a.End;l=a.Error;this.Notify({});return this}});return m}})(this);
